...
class NguCarousel extends NguCarouselStore {
    ...
    _touch() {
        if (this.inputs.touch) {
            Promise.resolve(/*! import() */).then(__webpack_require__.t.bind(null, /*! hammerjs */ "./node_modules/hammerjs/hammer.js", 7)).then(() => {
    ...
    _storeCarouselData() {
        this.deviceWidth = Object(_angular_common__WEBPACK_IMPORTED_MODULE_0__["isPlatformBrowser"])(this.platformId) ? window.innerWidth : 1200;
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/contact/contact.component.html":
/*!**************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/contact/contact.component.html ***!
  \**************************************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<section class=\"call-to-action gap primary-bg\">\n  <div class=\"container\">\n    <div fxLayout=\"row nowrap\" fxLayout.lt-md=\"column\" fxLayoutGap=\"20px\">\n      <div fxFlex=\"66.666\">\n        <h2>Illum et quis officiis beatae</h2>\n        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure nam, illum et quis officiis beatae.</p>\n      </div>\n      <div fxFlex=\"33.333\" fxLayoutAlign=\"center center\">\n        <button mat-raised-button mat-lg-button color=\"accent\">BUY NOW</button>\n      </div>\n    </div>\n  </div>\n</section>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/footer/footer.component.html":
/*!************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/footer/footer.component.html ***!
  \************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<header id=\"main-header\" [ngClass]=\"{'header-fixed': isFixed}\">\n    <div class=\"container\" fxLayout=\"row wrap\" fxLayoutAlign=\"start center\">\n        <div class=\"header-mobile-top\" fxLayout=\"row wrap\" fxLayoutAlign=\"start center\">\n            <div class=\"home-logo mr-1\">\n                <a href=\"/\">\n                    <img mat-card-image src=\"assets/images/nombre-logo.jpg\">\n                </a>\n            </div>\n            <button mat-icon-button id=\"menu-toggle\" (click)=\"toggleMenu()\"><mat-icon>menu</mat-icon></button>\n        </div>\n\n        <div fxFlex fxLayoutAlign=\"end\" class=\"top-menu\">\n\n            <button mat-button id=\"dashboard-topbtn\" class=\"hometop-btn\" scrollTo=\"intro-one-section\"\n                    (click)=\"toggleMenu()\"><strong>Home</strong></button>\n            <button mat-button id=\"dashboard-topbtn\" class=\"hometop-btn\" scrollTo=\"portfolio-section\"\n                    (click)=\"toggleMenu()\"><strong>Works</strong></button>\n            <button mat-button id=\"dashboard-topbtn\" class=\"hometop-btn\" scrollTo=\"service-section\"\n                    (click)=\"toggleMenu()\"><strong>Services</strong></button>\n            <button mat-button id=\"dashboard-topbtn\" class=\"hometop-btn\" scrollTo=\"testimonial-slider\"\n                    (click)=\"toggleMenu()\"><strong>Testimonials</strong></button>\n            <button mat-button id=\"dashboard-topbtn\" class=\"hometop-btn\" scrollTo=\"pricings-section\"\n                    (click)=\"toggleMenu()\"><strong>Pricings</strong></button>\n            <button mat-button id=\"dashboard-topbtn\" class=\"hometop-btn\" scrollTo=\"contact-section\"\n                    (click)=\"toggleMenu()\"><strong>Contact</strong></button>\n        </div>\n    </div>\n</header>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/intro-one/intro-one.component.html":
/*!******************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/intro-one/intro-one.component.html ***!
  \******************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<section id=\"testimonial-slider\" class=\"testimonials-section gap primary-bg\">\n\t <div class=\"container\">\n\t\t  <div fxLayout='column' class=\"text-center mb-5 white-color\">\n\t\t\t\t<div fxFlex.gt-md=\"60%\">\n\t\t\t\t\t <h2 class=\"title-page\">What our customers says</h2>\n\t\t\t\t\t <p class=\"lead w-60\"> Consectetur adipisicing elit. Velit id error rem qui. Neque aperiam saepe placeat vero reprehenderit. </p>\n\t\t\t\t</div>\n\t\t  </div>\n\t\t  <div fxLayout=\"row wrap\" fxLayoutAlign=\"center center\" *ngIf=\"carouselOptions\">\n\t\t\t\t<div fxFlex.xs=\"90\" fxFlex.sm=\"80\" fxFlex.md=\"70\" fxFlex.lg=\"50\" fxFlex.xl=\"50\">\n\t\t\t\t\t <ngu-carousel #myCarousel [inputs]=\"carouselOptions\" [dataSource]=\"testimonials\">\n\t\t\t\t\t\t  <ngu-tile *nguCarouselDef=\"let tm; let i = index \">\n\t\t\t\t\t\t\t\t<mat-card class=\"p-0\">\n\t\t\t\t\t\t\t\t\t <mat-card-content class=\"text-center\">\n\t\t\t\t\t\t\t\t\t\t  <div class=\"user-content\">\n\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"testimonial-img\"><img [src]=\"tm.photo\" alt=\"\"></div>\n\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"text\">{{tm.text}}</p>\n\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"user-title\">{{tm.title}}</div>\n\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"user-subtitle text-muted\">{{tm.subtitle}}</div>\n\t\t\t\t\t\t\t\t\t\t  </div>\n\t\t\t\t\t\t\t\t\t </mat-card-content>\n\t\t\t\t\t\t\t\t</mat-card>\n\t\t\t\t\t\t  </ngu-tile>\n\t\t\t\t\t\t  <button mat-fab NguCarouselPrev class='carousel-left'><mat-icon>keyboard_arrow_left</mat-icon></button>\n\t\t\t\t\t\t  <button mat-fab NguCarouselNext class='carousel-right'><mat-icon>keyboard_arrow_right</mat-icon></button>\n\t\t\t\t\t </ngu-carousel>\n\t\t\t\t</div>\n\t\t  </div>\n\t </div>\n</section>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/testimonials/testimonials.component.html":
/*!************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/testimonials/testimonials.component.html ***!
  \************************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dHMvc2hhcmVkLXNlY3Rpb25zL2NvbnRhY3QvY29udGFjdC5jb21wb25lbnQuc2NzcyJ9 */");
...
var ContactComponent = /** @class */ (function () {
    ...
    ContactComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./contact.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/contact/contact.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./contact.component.scss */ "./src/app/layouts/shared-sections/contact/contact.component.scss")).default]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".call-to-action {\n  color: #ffffff;\n}\n\n@media (max-width: 960px) {\n  .call-to-action {\n    text-align: center;\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var CtaComponent = /** @class */ (function () {
    ...
    CtaComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-cta',
            template: __importDefault(__webpack_require__(/*! raw-loader!./cta.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/cta/cta.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./cta.component.scss */ "./src/app/layouts/shared-sections/cta/cta.component.scss")).default]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".footer-wrapper {\n  background-color: #ffffff;\n}\n\n.mat-list-item {\n  color: #ffffff !important;\n}\n\n.footer-item {\n  padding: 30px;\n  box-shadow: 3px 0px 4px rgba(0, 0, 0, 0.2);\n}\n\n.footer-box:first-child {\n  padding-left: 0;\n}\n\n.footer-box-title {\n  position: relative;\n  margin: 0 0 24px;\n  padding-bottom: 12px;\n}\n\n.footer-box-title::after {\n  content: \"\";\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  height: 2px;\n  width: 64px;\n  background-color: #ffc107;\n}\n\n.footer-item .mat-list {\n  padding: 0 !important;\n}\n\n.footer-item .mat-list-item-content {\n  padding-left: 0 !important;\n}\n\n.footer-item .mat-list-text {\n  color: #ffffff;\n}\n\n.text-footer {\n  color: #000;\n  margin: 0;\n}\n\n@media (max-width: 959px) {\n  .footer-box:first-child {\n    padding-left: 30px;\n  }\n  .footer-box {\n    box-shadow: 0px 3px 2px rgba(0, 0, 0, 0.2);\n  }\n  .footer-item {\n    padding: 30px 15px;\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var FooterComponent = /** @class */ (function () {
    ...
    FooterComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-footer',
            template: __importDefault(__webpack_require__(/*! raw-loader!./footer.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/footer/footer.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./footer.component.scss */ "./src/app/layouts/shared-sections/footer/footer.component.scss")).default]
        }),
        __metadata("design:paramtypes", [])
    ], FooterComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("#main-header {\n  position: absolute;\n  width: 100%;\n  background: transparent;\n  top: 0;\n  left: 0;\n  right: 0;\n  padding: 22px 0;\n  transition: padding 0.3s linear;\n  -webkit-transition: padding 0.3s linear;\n  z-index: 999;\n}\n\n#main-header .mat-button {\n  color: #fff;\n}\n\n#main-header > .container {\n  height: auto;\n}\n\n.hometop-btn:hover ::ng-deep .mat-button-focus-overlay {\n  display: none;\n}\n\n#main-header:not(.header-fixed) .hometop-btn ::ng-deep .mat-button-ripple {\n  top: -22px;\n  bottom: -22px;\n}\n\n#main-header.header-fixed {\n  position: fixed !important;\n  left: 0;\n  right: 0;\n  top: 0;\n  background: #fff !important;\n  padding: 0 !important;\n  box-shadow: 0 0 4px rgba(0, 0, 0, 0.14), 0 4px 8px rgba(0, 0, 0, 0.28);\n  -webkit-animation: .6s slideDown forwards;\n          animation: .6s slideDown forwards;\n}\n\n#main-header.header-fixed .mat-button {\n  color: #000000;\n}\n\n#main-header.header-fixed .home-logo h2 {\n  color: #000;\n  margin: 0;\n}\n\n.header-fixed .container {\n  height: 60px !important;\n}\n\n.header-fixed .hometop-btn {\n  line-height: 60px !important;\n}\n\n#main-header .home-logo {\n  display: flex;\n  align-items: center;\n}\n\n#main-header .home-logo a {\n  display: inherit;\n}\n\n#main-header .home-logo h2 {\n  color: #fff;\n}\n\n#menu-toggle {\n  display: none;\n  position: absolute;\n  right: 5px;\n  top: 10px;\n}\n\n.icon-button .mat-icon {\n  font-size: 20px;\n}\n\n@media (max-width: 991px) {\n  #main-header {\n    padding: 0;\n  }\n  #main-header .mat-button {\n    color: #000;\n  }\n  #main-header #menu-toggle {\n    color: #ffffff;\n  }\n  #main-header.header-fixed #menu-toggle {\n    color: #000;\n  }\n  #main-header > .container {\n    height: 60px;\n    padding: 0;\n  }\n  .menu-opened:host .header-mobile-top {\n    padding: 13px 0;\n  }\n  #menu-toggle {\n    display: block;\n  }\n  .menu-opened:host .container {\n    height: auto !important;\n  }\n  .home-logo {\n    margin-left: 15px;\n  }\n  .top-menu {\n    display: none !important;\n  }\n  .menu-opened:host .top-menu {\n    display: block !important;\n    width: 100% !important;\n    flex: none !important;\n    background: #f3f3f3;\n  }\n  .menu-opened:host .top-menu button {\n    display: block;\n    width: 100%;\n    line-height: 56px !important;\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-header',
            template: __importDefault(__webpack_require__(/*! raw-loader!./header.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/header/header.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./header.component.scss */ "./src/app/layouts/shared-sections/header/header.component.scss")).default]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".home-intro-section {\n  padding: 180px 0;\n  color: #ffffff;\n  overflow: hidden;\n}\n\n.home-intro-title {\n  margin: 0 0 24px;\n  font-size: 48px;\n  font-weight: 900;\n  line-height: 52px;\n  text-shadow: 0 4px 4px rgba(0, 0, 0, 0.22);\n}\n\n.home-intro-desc {\n  margin: 0 0 40px;\n  font-size: 22px;\n  font-weight: 400;\n  line-height: 32px;\n}\n\n.intro-list {\n  margin: 0 0 40px;\n}\n\n.intro-product {\n  position: relative;\n  top: 100px;\n  left: 20px;\n}\n\n.intro-product-link {\n  position: absolute;\n  top: -110px;\n  left: -45px;\n  text-align: center;\n  display: block;\n  width: 160px;\n  height: 160px;\n  border-radius: 50%;\n  background: #fff;\n  color: rgba(0, 0, 0, 0.87);\n  padding: 37px 20px;\n  box-sizing: border-box;\n  overflow: hidden;\n  box-shadow: 0 14px 32px rgba(0, 0, 0, 0.2);\n  transition: all .3s ease;\n}\n\n.intro-product-link:hover {\n  box-shadow: 0 19px 32px rgba(0, 0, 0, 0.4);\n}\n\n.intro-product-link .price {\n  font-size: 32px;\n  font-weight: 700;\n}\n\n.intro-product-link .price-text {\n  font-size: 14px;\n}\n\n@media (max-width: 767px) {\n  .intro-product {\n    top: 80px;\n    left: 20px;\n    margin-bottom: 4rem;\n  }\n  .home-intro-section {\n    padding: 100px 0 60px;\n  }\n  .home-intro-title {\n    margin: 0 0 30px;\n    font-size: 32px;\n    font-weight: 900;\n    line-height: 38px;\n    text-shadow: 0 4px 4px rgba(0, 0, 0, 0.22);\n  }\n  .home-intro-desc {\n    margin: 0 0 40px;\n    font-size: 18px;\n    font-weight: 400;\n    line-height: 27px;\n  }\n  .intro-product-link {\n    top: -80px;\n    transform: scale(0.5);\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var IntroOneComponent = /** @class */ (function () {
    ...
    IntroOneComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-intro',
            template: __importDefault(__webpack_require__(/*! raw-loader!./intro-one.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/intro-one/intro-one.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./intro-one.component.scss */ "./src/app/layouts/shared-sections/intro-one/intro-one.component.scss")).default]
        }),
        __metadata("design:paramtypes", [])
    ], IntroOneComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".item .mat-card {\n  margin: 0 16px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var PortfolioCarouselComponent = /** @class */ (function () {
    ...
    PortfolioCarouselComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./portfolio-carousel.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/portfolio-carousel/portfolio-carousel.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./portfolio-carousel.component.scss */ "./src/app/layouts/shared-sections/portfolio-carousel/portfolio-carousel.component.scss")).default]
        }),
        __metadata("design:paramtypes", [])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dHMvc2hhcmVkLXNlY3Rpb25zL3BvcnRmb2xpby9wb3J0Zm9saW8uY29tcG9uZW50LnNjc3MifQ== */");
...
var PortfolioComponent = /** @class */ (function () {
    ...
    PortfolioComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./portfolio.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/portfolio/portfolio.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./portfolio.component.scss */ "./src/app/layouts/shared-sections/portfolio/portfolio.component.scss")).default]
        }),
        __metadata("design:paramtypes", [])
    ], PortfolioComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".plan-pricing .mat-list-item ::ng-deep .mat-list-item-content {\n  display: inline-flex !important;\n  text-align: center;\n  font-size: .875rem !important;\n}\n\n.plan-pricing {\n  background: #3f51b5;\n  color: #fff;\n}\n\n.plan-pricing p {\n  color: #fff;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var PricingsComponent = /** @class */ (function () {
    ...
    PricingsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./pricings.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/pricings/pricings.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./pricings.component.scss */ "./src/app/layouts/shared-sections/pricings/pricings.component.scss")).default]
        }),
        __metadata("design:paramtypes", [])
    ], PricingsComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".service-card-two {\n  padding-top: 2rem;\n  padding-bottom: 2rem;\n}\n\n@media (min-width: 600px) {\n  .service-card-two {\n    padding: 2rem;\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var ServicesCarouselComponent = /** @class */ (function () {
    ...
    ServicesCarouselComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./services-carousel.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/services-carousel/services-carousel.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./services-carousel.component.scss */ "./src/app/layouts/shared-sections/services-carousel/services-carousel.component.scss")).default]
        }),
        __metadata("design:paramtypes", [])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".services-wrappper .service-card {\n  text-align: center;\n  padding: 2rem;\n}\n\n.services-wrappper .service-card .icon-cap {\n  display: inline-block;\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n  padding: 1rem;\n  margin-bottom: 1rem;\n}\n\n.services-wrappper .service-card .icon-cap i {\n  font-size: 3rem;\n}\n\n.services-wrappper mat-card {\n  margin: 1rem;\n}\n\n@media (max-width: 767px) {\n  .services-wrappper .service-card {\n    padding: 1rem;\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var ServicesComponent = /** @class */ (function () {
    ...
    ServicesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./services.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/services/services.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./services.component.scss */ "./src/app/layouts/shared-sections/services/services.component.scss")).default]
        }),
        __metadata("design:paramtypes", [])
    ], ServicesComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".testimonials-section .user-content p {\n  font-size: 1.4rem !important;\n  line-height: 1.3;\n  font-weight: lighter;\n}\n\n.testimonial-img img {\n  width: 80px !important;\n  height: 80px;\n  margin-bottom: 1rem;\n  border-radius: 100%;\n}\n\n.white-color p,\n.white-color h2 {\n  color: #fff;\n}\n\n.ngucarouselPoint li {\n  color: #fff;\n}\n\n.item .mat-card {\n  margin: 0 16px;\n}\n\n.item .mat-card .mat-card-content {\n  position: relative;\n  padding: 2rem;\n}\n\n.item .mat-card .company-logo {\n  padding-bottom: 24px;\n}\n\n.item .mat-card .text {\n  position: relative;\n  font-size: 1rem;\n  color: rgba(0, 0, 0, 0.64);\n  padding-bottom: 25px;\n  margin: 0;\n}\n\n.item .mat-card .user-detail {\n  position: absolute;\n  bottom: 25px;\n  left: 32px;\n  right: 0;\n  margin: auto;\n}\n\n.item .mat-card .user-detail .user-photo {\n  float: left;\n  margin-right: 8px;\n}\n\n.item .mat-card .user-detail .user-title {\n  font-size: 1rem;\n  float: left;\n  width: calc(100% - 56px);\n}\n\n.item .mat-card .user-detail .user-subtitle {\n  float: left;\n}\n\n@media (max-width: 767px) {\n  .testimonials-section .user-content p {\n    font-size: 1rem !important;\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var TestimonialsCarouselComponent = /** @class */ (function () {
    ...
    TestimonialsCarouselComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./testimonials-carousel.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/testimonials-carousel/testimonials-carousel.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./testimonials-carousel.component.scss */ "./src/app/layouts/shared-sections/testimonials-carousel/testimonials-carousel.component.scss")).default]
        }),
        __metadata("design:paramtypes", [])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".testimonials-section .user-content p {\n  font-size: 1.4rem !important;\n  line-height: 1.3;\n  font-weight: lighter;\n}\n\n.testimonial-img {\n  padding-top: 2rem;\n}\n\n.testimonial-img img {\n  width: 80px !important;\n  height: 80px;\n  margin-bottom: 1rem;\n  border-radius: 100%;\n}\n\n.white-color p,\n.white-color h2 {\n  color: #fff;\n}\n\n.ngucarouselPoint li {\n  color: #fff;\n}\n\n.item .mat-card {\n  margin: 0 16px;\n}\n\n.item .mat-card .mat-card-content {\n  position: relative;\n  padding: 2rem;\n}\n\n.item .mat-card .company-logo {\n  padding-bottom: 24px;\n}\n\n.item .mat-card .text {\n  position: relative;\n  font-size: 1rem;\n  color: rgba(0, 0, 0, 0.64);\n  padding-bottom: 25px;\n  margin: 0;\n}\n\n.item .mat-card .user-detail {\n  position: absolute;\n  bottom: 25px;\n  left: 32px;\n  right: 0;\n  margin: auto;\n}\n\n.item .mat-card .user-detail .user-photo {\n  float: left;\n  margin-right: 8px;\n}\n\n.item .mat-card .user-detail .user-title {\n  font-size: 1rem;\n  float: left;\n  width: calc(100% - 56px);\n}\n\n.item .mat-card .user-detail .user-subtitle {\n  float: left;\n}\n\n@media (max-width: 767px) {\n  .testimonials-section .user-content p {\n    font-size: 1rem !important;\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var TestimonialsComponent = /** @class */ (function () {
    ...
    TestimonialsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./testimonials.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layouts/shared-sections/testimonials/testimonials.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./testimonials.component.scss */ "./src/app/layouts/shared-sections/testimonials/testimonials.component.scss")).default]
        }),
        __metadata("design:paramtypes", [])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".mat-card {\n  text-align: center;\n  cursor: pointer;\n  padding: 0;\n  margin: 0;\n}\n\n.mat-card:active {\n  outline: 0;\n}\n\n:host ::ng-deep .mat-card-image {\n  vertical-align: bottom;\n}\n\n:host ::ng-deep .mat-ripple-element {\n  height: 0;\n}\n\n.main-layout h1 {\n  color: #fff;\n  margin-bottom: 3rem;\n}\n\n.main-layout h4 {\n  font-size: 2rem;\n  font-weight: bold;\n  padding: 2rem;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _ngu_carousel__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ngu/carousel */ "./node_modules/@ngu/carousel/__ivy_ngcc__/fesm2015/ngu-carousel.js");
...
/* harmony import */ var _layouts_shared_sections_header_header_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../layouts/shared-sections/header/header.component */ "./src/app/layouts/shared-sections/header/header.component.ts");
/* harmony import */ var _layouts_shared_sections_intro_one_intro_one_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../layouts/shared-sections/intro-one/intro-one.component */ "./src/app/layouts/shared-sections/intro-one/intro-one.component.ts");
/* harmony import */ var _layouts_shared_sections_portfolio_portfolio_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../layouts/shared-sections/portfolio/portfolio.component */ "./src/app/layouts/shared-sections/portfolio/portfolio.component.ts");
/* harmony import */ var _layouts_shared_sections_services_services_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../layouts/shared-sections/services/services.component */ "./src/app/layouts/shared-sections/services/services.component.ts");
/* harmony import */ var _layouts_shared_sections_cta_cta_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../layouts/shared-sections/cta/cta.component */ "./src/app/layouts/shared-sections/cta/cta.component.ts");
/* harmony import */ var _layouts_shared_sections_pricings_pricings_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../layouts/shared-sections/pricings/pricings.component */ "./src/app/layouts/shared-sections/pricings/pricings.component.ts");
/* harmony import */ var _layouts_shared_sections_contact_contact_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../layouts/shared-sections/contact/contact.component */ "./src/app/layouts/shared-sections/contact/contact.component.ts");
/* harmony import */ var _layouts_shared_sections_footer_footer_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../layouts/shared-sections/footer/footer.component */ "./src/app/layouts/shared-sections/footer/footer.component.ts");
/* harmony import */ var _layouts_shared_sections_testimonials_testimonials_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../layouts/shared-sections/testimonials/testimonials.component */ "./src/app/layouts/shared-sections/testimonials/testimonials.component.ts");
/* harmony import */ var _layouts_shared_sections_portfolio_carousel_portfolio_carousel_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../layouts/shared-sections/portfolio-carousel/portfolio-carousel.component */ "./src/app/layouts/shared-sections/portfolio-carousel/portfolio-carousel.component.ts");
/* harmony import */ var _layouts_shared_sections_testimonials_carousel_testimonials_carousel_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ../layouts/shared-sections/testimonials-carousel/testimonials-carousel.component */ "./src/app/layouts/shared-sections/testimonials-carousel/testimonials-carousel.component.ts");
/* harmony import */ var _layouts_shared_sections_services_carousel_services_carousel_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../layouts/shared-sections/services-carousel/services-carousel.component */ "./src/app/layouts/shared-sections/services-carousel/services-carousel.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    DemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _layouts_shared_sections_header_header_component__WEBPACK_IMPORTED_MODULE_21__["HeaderComponent"],
                _layouts_shared_sections_intro_one_intro_one_component__WEBPACK_IMPORTED_MODULE_22__["IntroOneComponent"],
                _layouts_shared_sections_portfolio_portfolio_component__WEBPACK_IMPORTED_MODULE_23__["PortfolioComponent"],
                _layouts_shared_sections_services_services_component__WEBPACK_IMPORTED_MODULE_24__["ServicesComponent"],
                _layouts_shared_sections_cta_cta_component__WEBPACK_IMPORTED_MODULE_25__["CtaComponent"],
                _layouts_shared_sections_pricings_pricings_component__WEBPACK_IMPORTED_MODULE_26__["PricingsComponent"],
                _layouts_shared_sections_contact_contact_component__WEBPACK_IMPORTED_MODULE_27__["ContactComponent"],
                _layouts_shared_sections_footer_footer_component__WEBPACK_IMPORTED_MODULE_28__["FooterComponent"],
                _layouts_shared_sections_testimonials_testimonials_component__WEBPACK_IMPORTED_MODULE_29__["TestimonialsComponent"],
                _layouts_shared_sections_portfolio_carousel_portfolio_carousel_component__WEBPACK_IMPORTED_MODULE_30__["PortfolioCarouselComponent"],
                _layouts_shared_sections_testimonials_carousel_testimonials_carousel_component__WEBPACK_IMPORTED_MODULE_31__["TestimonialsCarouselComponent"],
                _layouts_shared_sections_services_carousel_services_carousel_component__WEBPACK_IMPORTED_MODULE_32__["ServicesCarouselComponent"]
            ],
